...
wget -O /usr/bin/monitor_quota.py https://raw.githubusercontent.com/kipas77pro/FINALIZED/main/limit_handler/monitor_quota.py

# Download autokill.py
echo "✅ Downloading monitor_autokill.py..."
wget -O /usr/bin/monitor_autokill.py https://raw.githubusercontent.com/kipas77pro/FINALIZED/main/limit_handler/monitor_autokill.py
